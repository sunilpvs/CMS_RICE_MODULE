...
DROP TABLE IF EXISTS `tbl_lease_dates`;
...
('SCBC-INW23-', 0001, 'SCBC-INW23-0001', 0001, 1, '2023-07-01', '2023-12-31', 1, 5, 1, '2023-09-05 09:55:16', NULL, NULL),
('SCBC-INW23-', 0002, 'SCBC-INW23-0002', 0003, 2, '2023-04-26', '2025-05-25', 1, 4, 3, '2023-10-16 12:42:33', NULL, NULL),
('SCBC-INW23-', 0003, 'SCBC-INW23-0003', 0002, 1, '2024-04-02', '2024-07-31', 1, 4, 1, '2024-04-02 17:16:05', NULL, NULL),
('SCBC-INW23-', 0008, 'SCBC-INW23-0008', 0001, 1, '2024-08-27', '2024-08-28', 1, 4, 1, '2024-08-27 08:25:18', NULL, NULL);
...
DELIMITER ;
-- --------------------------------------------------------
-- Table structure for table `tbl_lease_dates`
CREATE TABLE `tbl_lease_dates` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tbl_lease_dates` (`id`, `lease`, `lease_type`, `start_date`, `end_date`, `lease_ref`) VALUES
(1, 'Inward', 1, '2023-06-07', '2023-12-31', 1),
(2, 'Inward', 2, '2024-01-01', '2024-12-31', 1);
-- --------------------------------------------------------
...
('SCBC-OUT23-', 0002, '', 0003, 1, 'SCBC-OUT23-0002', 1, '2023-10-05', '2023-11-04', 30, 17190, 17190, 0, 4297, 4297, 0, 0.25, 0, 128925, 0, 128925, 6, 1, 1, 3, '2023-10-21 11:01:46', 0, '0000-00-00 00:00:00'),
('SCBC-OUT23-', 0010, '', 0002, 4, 'SCBC-OUT23-0010', 1, '2024-04-20', '2024-05-04', 14, 60000, 60000, 0, 15000, 15000, 0, 0.75, NULL, 630000, NULL, 630000, 5, 0, 1, 1, '2024-04-20 21:46:40', 0, '0000-00-00 00:00:00'),
('SCBC-OUT23-', 0011, '', 0003, 1, 'SCBC-OUT23-0011', 1, '2024-04-20', '2024-04-30', 10, 17190, 7190, 10000, 4297, 1797.5, 2500, 1.25, NULL, 89875, NULL, 89875, 5, 0, 1, 1, '2024-04-20 21:49:19', 0, '0000-00-00 00:00:00'),
('SCBC-OUT23-', 0012, '', 0003, 4, 'SCBC-OUT23-0012', 1, '2024-04-20', '2024-04-30', 10, 10000, 10000, 0, 2500, 2500, 0, 1.5, NULL, 150000, NULL, 150000, 5 , 0, 1, 1, '2024-04-20 21:49:47', 0, '0000-00-00 00:00:00');
-- --------------------------------------------------------
