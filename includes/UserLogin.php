...
class UserLogin
{
    ...
    {
        $query = "SELECT COUNT(0) as count from tbl_costcenter LIMIT 1;";
        $result = $this->db_handle->runBaseQuery($query);
        $count="";
        $cnt=mysqli_num_rows($result);  
        if($cnt>0)
    ...
    {
        $query = "SELECT COUNT(0) as count from tbl_warehouse LIMIT 1;";
        $result = $this->db_handle->runBaseQuery($query);
        $count="";
        $cnt=mysqli_num_rows($result);  
        if($cnt>0)
    ...
    {
        $query = "SELECT COUNT(0) as count from tbl_lessor LIMIT 1;";
        $result = $this->db_handle->runBaseQuery($query);
        $count="";
        $cnt=mysqli_num_rows($result);  
        if($cnt>0)
    ...
    {
        $query = "SELECT COUNT(0) as count from tbl_commodity LIMIT 1;";
        $result = $this->db_handle->runBaseQuery($query);
        $count="";
        $cnt=mysqli_num_rows($result);  
        if($cnt>0)
