<?php 
    ...
    class Generic
    {
        ...
        {
            $sql = "SELECT id, ctype FROM vw_ctype WHERE id NOT IN (1,2,3);";
            $result = $this->db_handle->runBaseQuery($sql);
            return $result;
        }  
        ...
        {
            $sql = "SELECT id, contact, ctype FROM vw_contact WHERE ctype IN (2,3);";
            $result = $this->db_handle->runBaseQuery($sql);
            return $result;
        }    
        ...
        {
            $sql = "SELECT id, contact, ctype FROM vw_contact WHERE ctype = 5;";
            $result = $this->db_handle->runBaseQuery($sql);
            return $result;
        }    
