...
<form name="frmAdd" method="post" action="" id="frmAdd"
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control demoInputBox" id="f_name" name= "f_name" placeholder="irst Name" required>
    </div>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="date" class="form-control demoInputBox" id="email" name= "email" placeholder="Email" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Mobile</label><span
            id="mobile-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="mobile" name= "mobile" placeholder="Mobile" required>
    </div>
   <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Add Ref1</label><span
            id="add_ref1-info" class="info"></span>
      <input type="message" class="form-control demoInputBox" id="add_ref1" name= "add_ref1" placeholder="Add Ref1" required>
    </div> 
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Add Ref2</label><span
            id="add_ref2-info" class="info"></span>
      <input type="message" class="form-control demoInputBox" id="add_ref2" name= "add_ref2" placeholder="Add Ref2" required>
    </div>
</div>
</div>
