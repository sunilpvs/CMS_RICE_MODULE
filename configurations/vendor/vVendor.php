...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Vendor Master
           
            <a href="/configurations/vendor/cVendor.php?action=vendor-add" class="btn btn-primary btn-md float-right" role="button">Add Vendor</a>
    </h3>
  </div>
  ...
  <div class="card-body">
    ...
    <thead style="background-color:#4e73df;">
       ...
       <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="/configurations/vendor/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
