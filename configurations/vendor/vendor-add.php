...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Vendor Details
    </h3>
  </div>
...
<form name="frmAdd" method="post" action="" id="frmAdd"
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3"> 
      ...
      <input type="text" class="form-control demoInputBox" id="vendor_name" name= "vendor_name" placeholder="Vendor Name" required>
    </div>
    ...
    <select id="primary_contact" name="primary_contact" class="form-control demoInputBox">
        ...
        <?php
            $gen = new Generic();
            $result = $gen->getVendorContactList();
            if (!empty($result)) {
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
                {   
        ?> 
