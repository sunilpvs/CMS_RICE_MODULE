 ...
 ?>
  ...
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Lease
            ...
            <a href="../../rice_module/leases/cLeases.php?action=leases-add" class="btn btn-primary btn-md float-right" role="button">Add Lease</a>
    </h3>
  </div>
    ...
    <tbody style="background-color:#ffffff; color: #000000;">
        ...
        <tr style="font-size:12px;">                
            ...
            <td><a class="btnEditAction"
                href="../../rice_module/leases/cLeases.php?action=leases-edit&id=<?php echo $row["id"]; ?>">
                <img src="../../img/icon-edit.png" />
                </a>
               <a class="btnDeleteAction" 
                href="../../rice_module/leases/cLeases.php?action=leases-delete&id=<?php echo $row["id"]; ?>">
