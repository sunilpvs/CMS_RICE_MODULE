...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">New Leases Details
...
<form name="frmAdd" method="post" action="" id="frmAdd"
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="number" class="form-control demoInputBox" id="Lease_obj" name= "Lease_obj" placeholder="Lease_obj" required>
    </div>
    
    <div class="col-md-4 mb-3">
      <label for="validationDefault02" class="info">Contract_id</label><span
            id="Contract_id-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="Contract_id" name= "Contract_id" placeholder="Contract_id"  required>
    </div>
    
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Customer_id</label><span
            id="Customer_id-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="Customer_id" name= "Customer_id" placeholder="Customer_id" required>
    </div>

    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Capacity (Sq.ft)</label><span
            id="Capacity_sqft-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="Capacity_sqft" name= "Capacity_sqft" placeholder="Capacity Sqft" required>
    </div>

    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Commenced_Date</label><span
            id="Commenced_Date-info" class="info"></span>
      <input type="date" class="form-control demoInputBox" id="Commenced_Date" name= "Commenced_Date" placeholder="Commenced_Date" required>
    </div>
   ...
   <div class="col-md-4 mb-3">
      ...
      <input type="date" class="form-control demoInputBox" id="Complete_Date" name= "Complete_Date" placeholder="Complete_Date" required>
    </div> 
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Capacity_Mton</label><span
            id="Capacity_Mton-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="Capacity_Mton" name= "Capacity_Mton" placeholder="Capacity_Mton" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Rate/Day</label><span
            id="RateDay-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="RateDay" name= "RateDay" placeholder="RateDay" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Commodity_Type</label><span
            id="Commodity_Type-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="Commodity_Type" name= "Commodity_Type" placeholder="Commodity_Type" required>
    </div>
   
   <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Contact_Days</label><span
            id="Contact_Days-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="Contact_Days" name= "Contact_Days" placeholder="Contact_Days" required>
    </div> 
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Total_Cost</label><span
            id="Total_Cost-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="Total_Cost" name= "Total_Cost" placeholder="Total_Cost" required>
    </div> 
  ...
  <div class="container">
            <div class="col-md-4 mb-3">
                ...
                <button class="btn btn-primary" type="cancel" name="cancel" id="btnCancel" value="Cancel" ><a style="color:white;" href ="../../rice_module/leases/cLeases.php">Cancel</a></button> 
            </div>
        </div>
