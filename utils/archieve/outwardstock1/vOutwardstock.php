 ...
 ?>
  ...
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Lease
            ...
            <a href="../../bulk_ops/outwardstock/cOutwardstock.php?action=leases-add" class="btn btn-primary btn-md float-right" role="button">Add Lease</a>
    </h3>
  </div>
        ...
        <tr style="font-size:12px;">                
            ...
            <td><a class="btnEditAction"
               ...
               <a class="btnDeleteAction" 
                href="../../bulk_ops/loutwardstock/cOutwardstock.php?action=outwardstock-delete&id=<?php echo $row["id"]; ?>">
