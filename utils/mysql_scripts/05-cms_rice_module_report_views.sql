...
CREATE OR REPLACE VIEW `vw_rpt_daily_customer_outwardstock` AS 
	SELECT b.id as customer_id, b.customer_name, c.warehouse_name, d.compartment_name, e.commodity, f.transport_mode, g.name as delivery, date_format(a.outward_date,'%d-%b-%y') as outward_date, 
