...
<br>
    <form name="frmAdd" method="post" action="../../reports/daily_customer_stock/daily_cust_stock_pdf.php" id="frmAdd" target="_blank">
        <h3 class="m-0 font-weight-bold text-primary">
        ...
        <button class="btn btn-primary" type="submit" name="btnSubmit" id="btnSubmit" value="GeneratePDF">Generate PDF</button>
            <!-- 
