...
.invoice_wrapper .body .main_table .row .col_des{width: 60%;text-align: left;}
.invoice_wrapper .body .main_table .row .col_price{width: 10%; text-align: center;}
...
533 003. A.P., lndia, Contact : 9l-884-2361567, 9l-884-2361569, E-mail : scbc@shrichandrabulk.com</p></center>
<h6>CIN : U74900AP2009PTC064815 GSTIN : 37AAECR9430I1ZX PAN : AAECR9403L</h6>
			...
			<div class="bill_total_wrap">
				<div class="bill_sec">
			        ...
			        <span>
			           Customer Name: 
			           value="<?php echo $inward_sock["commodity_name"]; ?>"
			         <br/><br>
			           Arrival Of <?php $commodity ?>
			        </span>
				</div>
				<div class="total_wrap">
					<h6>Date: 25-05-2025</h6>
	        <h6>Report No:56</h6>
				</div>
			</div>
		</div>
