<?php
 ...
 ?>
  ...
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Outward Leases Report
  ...
  <div class="card-body">
    ...
    <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../reports/outward_leases/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
    </div>
  </div>
</div>
