...
<div class="container-fluid">
  ...
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Inward Lease Report
        <!--<a href="../../bulk_ops/inwardlease/cInwardlease.php?action=inwardlease-add" class="btn btn-primary btn-md float-right" role="button">Add Inward-Lease</a>-->
    </h3>
  </div>
  <div class="card-body">
    ...
    <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../reports/inward_leases/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
    </div>
  </div>
</div>
