 ...
 ?>
  ...
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Outward Leases
            ...
            <!--<a href="../../reports/outward_leases/cOutwardlease.php?action=outwardlease-add" class="btn btn-primary btn-md float-right" role="button">Add Outwardlease</a>-->
    </h3>
  </div>
    ...
    <tbody style="background-color:#ffffff; color: #000000;">
        ...
        <tr style="font-size:12px;">                
            ...
            <!-- <td><a class="btnEditAction"
                href="../../bulk_ops/outwardlease/cOutwardlease.php?action=outwardlease-edit&id=<?php echo $row["id"]; ?>">
                <img src="../../img/icon-edit.png" />
                </a>
                
                    <a class="btnDeleteAction" 
                    href="../../bulk_ops/outwardlease/cOutwardlease.php?action=outwardlease-delete&id=<?php //echo $row["id"]; ?>">
...
<h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../reports/outward_stock/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
