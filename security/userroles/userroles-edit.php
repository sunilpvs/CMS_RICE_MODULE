...
<div class="container">
        ...
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
                <script>
	                ...
	                $(document).ready(function()
	                {
		                ...
		                $.ajax(
		                {
			            url:"check-deliveryrname-edit.php",
			            type:"POST",
    ...
    <div class="container">
        <div class="col-md-4 mb-3">
            ...
            <button class="btn btn-primary" type="cancel" name="cancel" id="btnCancel" value="Cancel" ><a style="color:white;" href ="../../bulk_ops/delivery/cDelivery.php">Cancel</a></button> 
        </div>
    </div>
