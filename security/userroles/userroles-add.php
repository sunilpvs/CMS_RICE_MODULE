...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">New User Role</h3>
  </div>
<div class="card-body">
...
<div class="container">
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">role_id</label><span id="role_id-info" class="info"></span>
      <input type="text" class="form-control demoInputBox" id="role_id" name= "role_id" placeholder="role_id"  required>
    </div>
    ...
    <div class="col-md-4 mb-12">
        ...
        <div class="container">
            <div class="col-md-4 mb-3">
                ...
                <button class="btn btn-primary" type="cancel" name="cancel" id="btnCancel" value="Cancel" ><a style="color:white;" href ="../../security/userroles/cUserroles.php">Cancel</a></button> 
            </div>
        </div>
...
function validate() {
    ...
    if(!$("#role_id").val()) {
        $("#role_id-info").html("(required)");
        $("#role_id").css('background-color','#FFFFDF');
        valid = false;
    }
