...
<div class="container">
  ...
  <div class="col-md-3 mb-3">
    ...
    <input type="number" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="empty_bag_wt" name= "empty_bag_wt" min="0" max="1000" step="0.001" placeholder="00.00" readonly>
  </div>

  <div class="col-md-3 mb-3">
    <label for="validationDefault01" class="info">Bag Weight</label><span id="bag_wt-info" class="info"></span>
    <input type="number" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="bag_wt" name= "bag_wt" placeholder="Bag Weight" disabled>
  </div>
  ...
  <div class="form-row">   
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" onKeyDown="return/[a-z0-9.⌦←→⌫-]/i.test(event.key)" class="form-control demoInputBox" id="dc_no" name= "dc_no" placeholder="DC Number"  required>
    </div>
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="vehicle_no" name= "vehicle_no" placeholder="Vehicle Number" required>
    </div>
    ...
    <label for="validationDefault03" class="info">Bag Gross Weight</label><span id="outward_gross_wt-info" class="info"></span>
      <input type="number" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="outward_gross_wt" name= "outward_gross_wt" min="0" max="99999999" placeholder="0.00" step="0.001" value="00.00" onchange="calculatebagdifference()">
    </div> 
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="number" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="outward_wb_gross_wt" name= "outward_wb_gross_wt" min="0" max="99999999" placeholder="0.00" step="0.001" value="00.00" onchange="calculatebridgedifference()">
    </div>

    <div class="col-md-3 mb-3">
      <label for="validationDefault03" class="info">Gross Weight Difference</label><span id="outward_diff_gross-info" class="info"></span>
      <input type="number" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="outward_diff_gross" name= "outward_diff_gross" min="0" max="99999999" placeholder="0.00" step="0.001" value="00.00"  readonly>
    </div> 

    <div class="col-md-3 mb-3">
      <label for="validationDefault03" class="info">Bag Net Weight</label><span id="outward_net_wt-info" class="info"></span>
      <input type="number" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="outward_net_wt" name= "outward_net_wt" min="0" max="99999999" placeholder="0.00" step="0.001" value="00.00" onchange="calculatebagdifference()">
    </div> 

    
    <div class="col-md-3 mb-3">
      <label for="validationDefault03" class="info">Weightbridge Net Weight</label><span id="outward_wb_net_wt-info" class="info"></span>
      <input type="number" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="outward_wb_net_wt" name= "outward_wb_net_wt" min="0" max="99999999" placeholder="0.00" step="0.001" value="00.00" onchange="calculatebridgedifference()">
    </div> 

    <div class="col-md-3 mb-3">
      <label for="validationDefault03" class="info">Net Weight Difference</label><span id=" outward_diff_net-info" class="info"></span>
      <input type="number" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="outward_diff_net" name= "outward_diff_net" min="0" max="99999999" placeholder="0.00" step="0.001" value="00.00"  readonly>
    </div>
