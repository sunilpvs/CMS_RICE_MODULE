...
<form name="frmAdd" method="post" action="" id="frmAdd" onSubmit="return validate();">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control demoInputBox" id="invoice_number" name= "invoice_number" placeholder="invoice_number" value="<?php echo $row1["invoice_number"]; ?>" required>
    </div>
        <div class="col-md-4 mb-3">
      <label for="validationDefault02" class="info">Invoice Date</label><span
            id="invoice_date-info" class="info"></span>
      <input type="date" class="form-control demoInputBox" id="invoice_date" name= "invoice_date" placeholder="invoice_date" value="<?php echo $row1["invoice_date"]; ?>" required>
    </div>

    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Miller Name</label><span
            id="miller_name-info" class="info"></span>
      <input type="text" class="form-control demoInputBox" id="miller_name" name="miller_name" placeholder="miller_name" value="<?php echo $row1["miller_name"]; ?>" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Gst Number</label><span
            id="gst_number-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="gst_number" name= "gst_number" placeholder="gst_number" value="<?php echo $row1["gst_number"]; ?>" required>
    </div>
   ...
   <div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control demoInputBox" id="godown_name" name= "godown_name" placeholder="Godown Name"  value="<?php echo $row1["godown_name"]; ?>" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Compartment Name</label><span
            id="compartment_name-info" class="info"></span>
      <input type="text" class="form-control demoInputBox" id="compartment_name" name= "compartment_name" placeholder="Compartment Name"  value="<?php echo $row1["compartment_name"]; ?>" required>
    </div>
   ...
   <div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control demoInputBox" id="bag_mark" name= "bag_mark" placeholder="Bag Mark" value="<?php echo $row1["bag_mark"]; ?>" required>
    </div> 
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control demoInputBox" id="bags_rec" name= "bags_rec" placeholder="No.of bags received" value="<?php echo $row1["bags_rec"]; ?>" required>
    </div>
