...
<div class="card-body">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
        <label for="validationDefault03" class="info">Source - Transportation</label><span id="mod_transport-info" class="info"></span>
    ...
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">No.of bags Stock</label><span
            id="inward_bags_stock-info" class="info"></span>
    ...
    <label for="validationDefault03" class="info">bag Gross Weight</label><span id="inward_gross_wt-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="inward_gross_wt" name= "inward_gross_wt" min="0" max="1000" placeholder="0.00" step="0.001" value="00.00" onchange="calculatebagdifference()">
    </div> 
  
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Bag Net Weight</label><span id="inward_net_wt-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="inward_net_wt" name= "inward_net_wt" min="0" max="1000" placeholder="0.00" step="0.001" value="00.00" onchange="calculatebagdifference()">
    </div> 

    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Weightbridge Gross Weight</label><span id="inward_wb_gross_wt-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="inward_wb_gross_wt" name= "inward_wb_gross_wt" min="0" max="1000" placeholder="0.00" step="0.001" value="00.00" onchange="calculatebridgedifference()">
    </div>
    
    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Weightbridge Net Weight</label><span id="inward_wb_net_wt-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="inward_wb_net_wt" name= "inward_wb_net_wt" min="0" max="1000" placeholder="0.00" step="0.001" value="00.00" onchange="calculatebridgedifference()">
    </div> 

    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Bag Weight Difference Gross</label><span id="inward_diff_gross-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="inward_diff_gross" name= "inward_diff_gross" min="0" max="1000" placeholder="0.00" step="0.001" value="00.00"  readonly>
    </div> 

    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Bag Weight Difference Net</label><span id="	inward_diff_net-info" class="info"></span>
      <input type="number" class="form-control demoInputBox" id="inward_diff_net" name= "inward_diff_net" min="0" max="1000" placeholder="0.00" step="0.001" value="00.00"  readonly>
    </div>
