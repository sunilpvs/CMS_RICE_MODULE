...
<form name="frmAdd" method="post" action="" id="frmAdd" onSubmit="return validate();">
   ...
   <select id="mod_transport" name="mod_transport" class="form-control demoInputBox">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text"  maxlength="15" onKeyDown="return/[a-z0-9⌦←→⌫-]/i.test(event.key)" class="form-control demoInputBox" id="gst_num" name= "gst_num" placeholder="GST Number" value="<?php echo $row1['gst_num']; ?>"  disabled>
    </div>
    <div class="col-md-4 mb-3">
      ...
      Box" id="place" name= "place" placeholder="Place" value="<?php echo $row1['place']; ?>" disabled>
    </div>
