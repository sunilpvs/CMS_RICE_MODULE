...
<div class="container">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" maxlength="4" onKeyDown="return/[a-z0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="cc_code" name= "cc_code" placeholder="CC_CODE" required value="<?php echo $row1["cc_code"]; ?>">
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" maxlength="16" onKeyDown="return/[0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="gst_no" name= "gst_no" placeholder="GST No" required value="<?php echo $row1["gst_no"]; ?>">
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" maxlength="6" onKeyDown="return/[0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="pin" name= "pin" placeholder="Pincode"value="<?php echo $row1["pin"]; ?>" required>
    </div>
