...
<div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Edit Branch/Costcenter Details</h3>
</div>
...
<div class="container">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" maxlength="4" onKeyDown="return/[a-z0-9.⌦←→⌫HT]/i.test(event.key)" class="form-control demoInputBox" id="cc_code" name= "cc_code" placeholder="CC_CODE" required value="<?php echo $row1["cc_code"]; ?>">
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" maxlength="16" onKeyDown="return/[0-9. ⌦←→⌫HT]/i.test(event.key)" class="form-control demoInputBox" id="gst_no" name= "gst_no" placeholder="GST No" required value="<?php echo $row1["gst_no"]; ?>">
    </div>
        
    <div class="col-md-4 mb-3">
        <label for="validationDefault05" class="info">Address1</label><span id="add1-info" class="info"></span>
        <input type="text" maxlength="50" class="form-control demoInputBox" id="add1" name= "add1" placeholder="Address1" value="<?php echo $row1["add1"]; ?>" required>
    </div>

    <div class="col-md-4 mb-3">
        <label for="validationDefault05" class="info">Address2</label><span id="add2-info" class="info"></span>
        <input type="text" maxlength="50" class="form-control demoInputBox" id="add2" name= "add2" placeholder="Address2" value="<?php echo $row1["add2"]; ?>" required>
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" maxlength="6" onKeyDown="return/[0-9.⌦←→⌫HT]/i.test(event.key)" class="form-control demoInputBox" id="pin" name= "pin" placeholder="Pincode"value="<?php echo $row1["pin"]; ?>" required>
    </div>
    ...
    <div class="col-md-4 mb-3">
        <input type="hidden" class="form-control demoInputBox" id="cc_type" name= "cc_type" placeholder="cc_type" value="<?php echo $row1["cc_type"]; ?>">
        <input type="hidden" class="form-control demoInputBox" id="costcenter_id" name= "costcenter_id" placeholder="costcenter_id" value="<?php echo $row1["id"]; ?>">
    </div>
  </div>
</div>
</form>
