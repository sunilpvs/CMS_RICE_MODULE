...
<form name="frmAdd" method="post" action="" id="frmAdd" onSubmit="return validate();">
    <div class="container">
       ...
       <div class="col-md-4 mb-3">
            ...
            <input type="text" maxlength = "4" onKeyDown="return/[a-z0-9. ⌦←→⌫HT]/i.test(event.key)" class="form-control demoInputBox" id="cc_code" name= "cc_code" placeholder="CC Code"  required>
        </div>

        
       <div class="col-md-4 mb-3">
            <label for="validationDefault02" class="info">Cin No:</label><span id="cin-info" class="info"></span>
            <input type="text" maxlength = "22"  onKeyDown="return/[a-z0-9. ⌦←→⌫HT]/i.test(event.key)" class="form-control demoInputBox" id="cin" name= "cin" placeholder="CIN NO"  required>
        </div>
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" maxlength="15"  onKeyDown="return/[a-z0-9.⌦←→⌫HT]/i.test(event.key)" class="form-control demoInputBox" id="gst_no" name= "gst_no" placeholder="GST No" required>
        </div>
