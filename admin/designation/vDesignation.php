<?php
 ...
 <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Designation Master           
            <a href="/admin/designation/cDesignation.php?action=designation-add" class="btn btn-primary btn-md float-right" role="button">Add Designation</a>
    </h3>
  </div>
                          ...
                          {  
                            ...
                            ?>
                              ...
                              <td><a class="btnEditAction"
                                  href="../../admin/designation/cDesignation.php?action=designation-edit&id=<?php echo $row["id"]; ?>">
                                  <img src="/assests/img/icon-edit.png" />
                                  </a>
                                  <a class="btnDeleteAction" 
                                  href="../../admin/designation/cDesignation.php?action=designation-delete&id=<?php echo $row["id"]; ?>">
  ...
  <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="/admin/designation/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
    <div class="well-sm col-sm-12">
		<div class="btn-group pull-right">	
			<!-- <form action="../../admin/designation/excel_export.php" method="post">					
