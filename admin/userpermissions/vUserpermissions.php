<?php
 ...
 <div class="card-header py-3">
                          ...
                          {  
                            ...
                            ?>
                              ...
                              <td><a class="btnEditAction"
                                  href="../../admin/userpermissions/cUserpermissions.php?action=suserpermissions-edit&id=<?php echo $row["id"]; ?>">
  ...
  <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../admin/userpermissions/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
