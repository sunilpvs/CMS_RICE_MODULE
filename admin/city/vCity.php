<?php
 ...
 <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">City Master          
            <a href="/admin/city/cCity.php?action=citi-add" class="btn btn-primary btn-md float-right" role="button">Add City</a>
    </h3>
  </div>
  ...
  <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../admin/city/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
