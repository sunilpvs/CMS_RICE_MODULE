<?php
 ...
 <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Pages         
            <a href="/admin/pages/cPages.php?action=pages-add" class="btn btn-primary btn-md float-right" role="button">Add Page</a>
    </h3>
  </div>
                          ...
                          {  
                            ...
                            ?>
                              ...
                              <td><a class="btnEditAction"
                                  href="../../admin/pages/cPages.php?action=pages-edit&id=<?php echo $row["id"]; ?>">
                                  <img src="/assests/img/icon-edit.png" />
                                  </a>
                                  <!--<a class="btnDeleteAction" 
                                  href="../../admin/state/cState.php?action=state-delete&id=<?php echo $row["id"]; ?>">
  ...
  <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../admin/pages/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
