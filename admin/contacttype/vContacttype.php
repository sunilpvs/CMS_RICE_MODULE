<?php
 ...
 <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Contact Type Master
            <a href="../../admin/contacttype/cContacttype.php?action=contacttype-add" class="btn btn-primary btn-md float-right" role="button">Add Contacttype</a>
    </h3>
  </div>
                          ...
                          {  
                            ...
                            ?>
                              ...
                              <td><a class="btnEditAction"
                                  href="../../admin/contacttype/cContacttype.php?action=contacttype-edit&id=<?php echo $row["id"]; ?>">
                                  <img src="/assests/img/icon-edit.png" />
                                  </a>
                                  <!--<a class="btnDeleteAction" 
                                  href="../../admin/contacttype/cContacttype .php?action=contacttype -delete&id=<?php echo $row["id"]; ?>">
  ...
  <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../admin/contacttype/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
