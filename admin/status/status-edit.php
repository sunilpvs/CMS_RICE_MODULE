 ...
 <div class="container">
   <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control demoInputBox" id="status" name= "status" placeholder="Status" value="<?php echo $row1["status"]; ?>" onchange="validateDuplicates()" required>
    </div>

    <div class="col-md-4 mb-3">
      <label for="validationDefault02" class="info">Module</label><span id="module-info" class="info"></span>
      <input type="text" class="form-control demoInputBox" id="module" name= "module" placeholder="Module" value="<?php echo $row1["module"]; ?>" onchange="validateDuplicates()" required>
    </div>
