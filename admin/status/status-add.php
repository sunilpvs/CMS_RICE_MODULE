 ...
 <div class="container">
   <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control demoInputBox" id="status" name= "status" placeholder="Status" onchange="validateDuplicates()" required>
    </div>
    
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">Module</label><span id="module-info" class="info"></span>
      <input type="text" class="form-control demoInputBox" id="module" name= "module" placeholder="Module" onchange="validateDuplicates()" required>
    </div>
    ...
    <script>      
        function validateDuplicates()
        {
            ...
            if(descode != "" && desstatus != "" && desmodule != "")
            {
                ...
                $.ajax(
                {
                    ...
                    type:"POST",
                    data:{status:desstatus,code:descode,module:desmodule},
    ...
    <div class="container">
      <div class="col-md-4 mb-3">
        ...
        <button class="btn btn-primary" type="cancel" name="cancel" id="btnCancel" value="Cancel" ><a style="color:white;" href ="../../admin/status/cStatus.php">Cancel</a></button> 
      </div>
    </div>
 </div>
</div>
