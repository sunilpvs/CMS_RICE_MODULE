   ...
   <div class="form-row">
    ...
    <div class="container">
      <div class="col-md-4 mb-3">
        ...
        <button class="btn btn-primary" type="cancel" name="cancel" id="btnCancel" value="Cancel" ><a style="color:white;" href ="../../admin/userroles/cUserroles.php">Cancel</a></button> 
      </div>
    </div>
 </div>
</div>
