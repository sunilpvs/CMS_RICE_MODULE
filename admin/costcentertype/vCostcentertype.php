<?php
 ...
 <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Costcentertype Master          
            <a href="/admin/costcentertype/cCostcentertype.php?action=costcentertype-add" class="btn btn-primary btn-md float-right" role="button">Add Costcentertype</a>
    </h3>
  </div>
    ...
    <table id="datatableid" class="table table-bordered table-dark" style="width:100%;">
            <thead style="background-color:#4e73df;">
                <tr style="font-size:12px;">
                    ...
                    <th><strong>Costcenter Type</strong></th>
                          ...
                          {  
                            ...
                            ?>
                              ...
                              <td><a class="btnEditAction"
                                  href="../../admin/costcentertype/cCostcentertype.php?action=costcentertype-edit&id=<?php echo $row["id"]; ?>">
                                  <img src="/assests/img/icon-edit.png" />
                                  </a>
                                  <!--<a class="btnDeleteAction" 
                                  href="../../admin/city/cCity.php?action=city-delete&id=<?php echo $row["id"]; ?>">
  ...
  <h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../admin/costcentertype/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
