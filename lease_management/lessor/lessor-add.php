...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">New Lessor Details
    </h3>
  </div>
...
<div class="container">
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3"> 
        ...
        <input type="text" class="form-control demoInputBox" id="lessor_name" name= "lessor_name" placeholder="Lessor Name" required>
    </div>
    ...
    <script>
        ...
        $("#lessor_name").on("focusout",function()
        {
		      ...
		      $.ajax(
		      {
			      url:"check-lessorname.php",
			      type:"POST",
			      data:{lessor_name:lessorname},
    ...
    <input type="number" maxlength="6" onKeyDown="return/[0-9.⌦←→⌫]/i.test(event.key)" class="form-control demoInputBox" id="pin" name= "pin" placeholder="Pincode" required>
    </div>
