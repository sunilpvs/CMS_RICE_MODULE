...
<div class="card-header py-3">
  <h3 class="m-0 font-weight-bold text-primary">Add New Warehouse Details</h3>
</div>
<div class="card-body">
...
<div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" onkeypress="return validateNumberOnly(event);" class="form-control demoInputBox" id="capacity_sqft" name= "capacity_sqft" placeholder="0.00" min="0" step="0.01" value ="0.00" onchange="derivemton()" onfocusout="derivemton()" required>
    </div>

    <div class="col-md-4 mb-3">
      <label for="validationDefault03" class="info">Capacity(Metric Ton)</label><span
            id="capacity_mton-info" class="info"></span>
      <input type="number" onkeypress="return validateNumberOnly(event);" class="form-control demoInputBox" id="capacity_mton" name= "capacity_mton" placeholder="0.00" step="0.01" value="0.00" min="0" readonly>
    </div>
