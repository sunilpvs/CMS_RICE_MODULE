...
include($_SERVER['DOCUMENT_ROOT'] .'/includes/header.php'); 
 ...
 ?>
  ...
  <div class="card-header py-3">
    <h3 class="m-0 font-weight-bold text-primary">Add/Edit Delivery Details
           
            <a href="/lease_management/delivery/cDelivery.php?action=delivery-add" class="btn btn-primary btn-md float-right" role="button">Add Delivery Name</a>
    </h3>
  </div>
...
<h3 class="m-0 font-weight-bold text-primary"  >
            ...
            <a href="../../lease_management/delivery/excel_export.php" class="btn btn-primary btn-md float-center" role="button" target="_blank"> Export Excel</a>
    </h3>
